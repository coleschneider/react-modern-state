...
export type CreateTaskMutation = { __typename?: "Mutation" } & {
  createTask: { __typename?: "TaskPayload" } & {
    task?: Maybe<
...
export type DeleteTaskMutation = { __typename?: "Mutation" } & {
  deleteTask: { __typename?: "DeleteTaskPayload" } & {
    updated?: Maybe<
      Array<{ __typename?: "Task" } & Pick<Task, "id" | "index">>
    >;
  };
};
...
export type FetchMoreTasksQuery = { __typename?: "Query" } & {
...
export type GetTasksQuery = { __typename?: "Query" } & {
  ...
  taskTags: { __typename?: "TaskTagsPayload" } & Pick<TaskTagsPayload, "tags">;
  allTasks: { __typename?: "TaskConnection" } & Pick<
    TaskConnection,
    "totalCount"
  >;
  allTaskTags: { __typename?: "TaskTagsPayload" } & Pick<
    TaskTagsPayload,
    "tags"
  >;
};
...
export type MoveTaskMutation = { __typename?: "Mutation" } & {
  moveTask: { __typename?: "TasksPayload" } & {
    tasks?: Maybe<Array<{ __typename?: "Task" } & Pick<Task, "id" | "index">>>;
  };
};
...
export type UpdateTaskMutation = { __typename?: "Mutation" } & {
  updateTask: { __typename?: "TaskPayload" } & {
    task?: Maybe<
      { __typename?: "Task" } & Pick<
        Task,
        | "id"
...
export function getSdk(
  ...
  return {
    createTask(
      ...
      return withWrapper(() =>
        client.request<CreateTaskMutation>(
    ...
    deleteTask(
      ...
      return withWrapper(() =>
        client.request<DeleteTaskMutation>(
          print(DeleteTaskDocument),
          variables,
          requestHeaders
        )
      );
    ...
    fetchMoreTasks(
      variables?: FetchMoreTasksQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<FetchMoreTasksQuery> {
      return withWrapper(() =>
        client.request<FetchMoreTasksQuery>(
          print(FetchMoreTasksDocument),
          variables,
          requestHeaders
        )
      );
    ...
    moveTask(
      variables: MoveTaskMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<MoveTaskMutation> {
      return withWrapper(() =>
        client.request<MoveTaskMutation>(
          print(MoveTaskDocument),
          variables,
          requestHeaders
        )
      );
